...
export class Hnd1Page {
  ...
  constructor(
    ...
    this.ngFirestoreCollectionFS = angularFirestore.collection<FILE>('filesCollectionFTHND1FS');
    this.ngFirestoreCollectionSS = angularFirestore.collection<FILE>('filesCollectionFTHND1SS');
  ...
  fileUploadFS(event: FileList) {
    ...
    const fileStoragePath = `filesStorage/FT/HND1/FS/${new Date().getTime()}_${file.name}`;
  ...
  fileUploadSS(event: FileList) {
    ...
    const fileStoragePath = `filesStorage/FT/HND1/SS/${new Date().getTime()}_${file.name}`;
