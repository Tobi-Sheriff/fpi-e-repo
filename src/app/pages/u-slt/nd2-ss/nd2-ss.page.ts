...
// @Component({
//   selector: 'app-nd2-ss',
//   templateUrl: './nd2-ss.page.html',
//   styleUrls: ['./nd2-ss.page.scss'],
// })
// export class Nd2SsPage implements OnInit {
//   constructor() { }
//   ngOnInit() {
//   }
// }
...
export class Nd2SsPage {
  ...
  constructor(
    ...
    this.ngFirestoreCollection2020 = angularFirestore.collection<FILE>('N/SLT/2/SS/2020');
    this.ngFirestoreCollection2021 = angularFirestore.collection<FILE>('N/SLT/2/SS/2021');
    this.ngFirestoreCollection2022 = angularFirestore.collection<FILE>('N/SLT/2/SS/2022');
