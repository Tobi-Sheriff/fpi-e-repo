...
export class Nd1Page implements OnInit {
  ...
  filesSLTND1FS: Observable<FILE[]>;
  filesSLTND1SS: Observable<FILE[]>;
  ...
  constructor(
    ...
    this.filesSLTND1FS = this.ngFirestoreCollectionFS.valueChanges();
    this.filesSLTND1SS = this.ngFirestoreCollectionSS.valueChanges();
  }
