...
export class Nd1FsPage {
  ...
  constructor(
    ...
    this.ngFirestoreCollection2020 = angularFirestore.collection<FILE>('N/SLT/1/FS/2020');
    this.ngFirestoreCollection2021 = angularFirestore.collection<FILE>('N/SLT/1/FS/2021');
    this.ngFirestoreCollection2022 = angularFirestore.collection<FILE>('N/SLT/1/FS/2022');
