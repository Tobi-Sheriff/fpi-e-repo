...
// @Component({
//   selector: 'app-hnd1-ss',
//   templateUrl: './hnd1-ss.page.html',
//   styleUrls: ['./hnd1-ss.page.scss'],
// })
// export class Hnd1SsPage implements OnInit {
//   constructor() { }
//   ngOnInit() {
//   }
// }
...
export class Hnd1SsPage {
  ...
  constructor(
    ...
    this.ngFirestoreCollection2020 = angularFirestore.collection<FILE>('H/SLT/1/SS/2020');
    this.ngFirestoreCollection2021 = angularFirestore.collection<FILE>('H/SLT/1/SS/2021');
    this.ngFirestoreCollection2022 = angularFirestore.collection<FILE>('H/SLT/1/SS/2022');
