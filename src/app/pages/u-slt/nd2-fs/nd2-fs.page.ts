...
// @Component({
//   selector: 'app-nd2-fs',
//   templateUrl: './nd2-fs.page.html',
//   styleUrls: ['./nd2-fs.page.scss'],
// })
// export class Nd2FsPage implements OnInit {
//   constructor() { }
//   ngOnInit() {
//   }
// }
...
export class Nd2FsPage {
  ...
  constructor(
    ...
    this.ngFirestoreCollection2020 = angularFirestore.collection<FILE>('N/SLT/2/FS/2020');
    this.ngFirestoreCollection2021 = angularFirestore.collection<FILE>('N/SLT/2/FS/2021');
    this.ngFirestoreCollection2022 = angularFirestore.collection<FILE>('N/SLT/2/FS/2022');
