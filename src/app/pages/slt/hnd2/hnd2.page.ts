...
export class Hnd2Page {
  ...
  constructor(
    ...
    this.ngFirestoreCollectionFS = angularFirestore.collection<FILE>('filesCollectionSLTHND2FS');
    this.ngFirestoreCollectionSS = angularFirestore.collection<FILE>('filesCollectionSLTHND2SS');
  ...
  fileUploadFS(event: FileList) {
    ...
    const fileStoragePath = `filesStorage/SLT/HND2/FS/${new Date().getTime()}_${file.name}`;
  ...
  fileUploadSS(event: FileList) {
    ...
    const fileStoragePath = `filesStorage/SLT/HND2/SS/${new Date().getTime()}_${file.name}`;
