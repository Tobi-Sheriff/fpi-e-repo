...
export class Nd2FsPage {
  ...
  constructor(
    ...
    this.ngFirestoreCollection2020 = angularFirestore.collection<FILE>('N/FT/2/FS/2020');
    this.ngFirestoreCollection2021 = angularFirestore.collection<FILE>('N/FT/2/FS/2021');
    this.ngFirestoreCollection2022 = angularFirestore.collection<FILE>('N/FT/2/FS/2022');
