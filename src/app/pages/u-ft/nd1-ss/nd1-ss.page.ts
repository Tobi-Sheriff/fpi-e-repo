...
export class Nd1SsPage {
  ...
  constructor(
    ...
    this.ngFirestoreCollection2020 = angularFirestore.collection<FILE>('N/FT/1/SS/2020');
    this.ngFirestoreCollection2021 = angularFirestore.collection<FILE>('N/FT/1/SS/2021');
    this.ngFirestoreCollection2022 = angularFirestore.collection<FILE>('N/FT/1/SS/2022');
